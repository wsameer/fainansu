...
Fainansu is built as a Progressive Web App (PWA) that can be installed on iOS and Android devices for a native app-like experience.
...
4. **Launch the app**:
   - Find the Fainansu icon on your home screen
...
3. **Launch the app**:
   - Find Fainansu in your app drawer
...
2. Create `Caddyfile`:
```
fainansu.yourdomain.com {
    reverse_proxy localhost:3001
}
```
3. Run: `caddy run`
4. Access: `https://fainansu.yourdomain.com`

**Using nginx**:
```nginx
server {
    listen 80;
    server_name fainansu.yourdomain.com;
    location / {
