...
export const SidebarLeft = ({ ...props }: React.ComponentProps<typeof Sidebar>) => {
  const { leftSidebarContent, showLeftSidebar } = useLayout();
        ...
        <Sidebar collapsible="none" className="hidden flex-1 md:flex">
          ...
          <SidebarContent>
            <SidebarGroup className="p-4">
              <SidebarGroupContent>{leftSidebarContent || <DefaultLeftSidebarContent />}</SidebarGroupContent>
            </SidebarGroup>
          </SidebarContent>
        </Sidebar>
      )}
