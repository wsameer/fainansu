      ...
      <FieldSet className="w-full">
        <FieldGroup>
          <Field orientation="horizontal">
            <FieldContent>
              <FieldLabel htmlFor="language-selector">Language</FieldLabel>
              <FieldDescription>Select the language of the platform</FieldDescription>
            </FieldContent>
            <Select id="language-selector" items={languages}>
              <SelectTrigger>
                <SelectValue />
              </SelectTrigger>
              <SelectContent>
          ...
          <Field orientation="horizontal">
            <FieldContent>
              ...
              <FieldDescription>Pick a font style for the application</FieldDescription>
            </FieldContent>
            <Select id="font-family" items={fonts}>
              <SelectTrigger>
                <SelectValue />
              </SelectTrigger>
              <SelectContent>
          ...
          <Field orientation="horizontal">
            <FieldContent>
              <FieldLabel htmlFor="reset-settings">Reset appearance</FieldLabel>
              <FieldDescription>
                This action resets all appearance settings to default and is irreversible
              </FieldDescription>
            </FieldContent>
            <Button size="sm" id="reset-settings" variant="destructive">
              Reset <RotateCcw />
            </Button>
          </Field>
