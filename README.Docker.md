# Docker Setup Guide for Fainansu

This guide explains how to run Fainansu in Docker for production deployments.
...
| `POSTGRES_DB` | Database name | fainansu |
...
```bash
docker exec -it fainansu-db psql -U postgres -d fainansu
```
